...
public class StateCollectFSMBehaviour extends OneShotBehaviour {
    ...
    public StateCollectFSMBehaviour(final AbstractDedaleAgent myagent, MapRepresentation myMap, List<String> agentNames, HashMap<String, HashMap<String, Boolean>> dico) {
        super(myagent);
        this.myMap = myMap;
